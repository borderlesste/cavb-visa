...
exports.AppointmentLetterService = void 0;
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
class AppointmentLetterService {
    static async generateAppointmentLetter(data) {
    ...
    static generateLetterHTML(data) {
...
<body>
    ...
    static async generateConfirmationLetter(appointmentId, data) {
    ...
    static getLetterPath(fileName) {
        return path.join(this.UPLOAD_DIR, fileName);
    }
    static async deleteAppointmentLetter(filePath) {
        try {
...
exports.AppointmentLetterService = AppointmentLetterService;
_a = AppointmentLetterService;
AppointmentLetterService.UPLOAD_DIR = path.join(__dirname, '../../uploads/appointment_letters');
(() => {
    // Ensure the upload directory exists
    if (!fs.existsSync(_a.UPLOAD_DIR)) {
        fs.mkdirSync(_a.UPLOAD_DIR, { recursive: true });
    }
})();
exports.default = AppointmentLetterService;
